...
function App() {
  ...
  useEffect(() => {
    if (supplierStatusCheck.showStatusDialog) {
      ...
      document.body.classList.remove("supplier-account-notification-active"); // UPDATED CLASS
    }

    return () => {
      document.body.classList.remove("supplier-account-notification-active");
    };
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <Router>
        <AuthProvider>
          <CartProvider>
            {supplierStatusCheck.showAlert && (
              <SupplierStatusBanner
                isOpen={supplierStatusCheck.showAlert}
                alertData={supplierStatusCheck.alertData}
                onClose={supplierStatusCheck.handleClose}
                onLogout={supplierStatusCheck.handleLogout}
              />
            )}
            <div className="app">
              <Navbar />
