...
const SystemSettings = () => {
  ...
  const settingsTabs = [
    ...
    { id: "advance-payment", label: "Advance Payment config", icon: Percent }, // Add this line
              ...
              <div className="setting-group">
                ...
                <div className="input-with-icon">
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingChange("business", "taxRate", e.target.value)
                    }
                    placeholder="18.0"
                  />
                  <Percent size={16} />
              ...
              <div className="setting-group checkbox-group">
                <label>
                  <input
                    type="checkbox"
                    checked={
                      settings.security?.requirePhoneVerification || false
                    }
                    onChange={(e) =>
                      handleSettingChange(
                        "security",
              ...
              <div className="maintenance-status">
                <div className="maintenance-info">
                  <h5>
                    Current Status:
                    <span
                      className={`status ${settings.maintenance?.enabled ? "enabled" : "disabled"}`}
                    >
