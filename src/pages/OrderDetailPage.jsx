                ...
                <div className="aggre-supplier-details">
                  ...
                  {order.supplier.contactPersonName && (
                    <div className="aggre-supplier-contact">
                      <FaUser />
                      Contact: {order.supplier.contactPersonName}
                    </div>
                  )}

                  {order.supplier.companyAddress && (
                    <div className="aggre-supplier-address">
                      <FaMapMarkerAlt />
                      {order.supplier.companyAddress}
                    </div>
                  )}
                  ...
                  {(order.supplier.city || order.supplier.state) && (
                    <div className="aggre-supplier-location">
                      ...
                      {order.supplier.pincode && ` - ${order.supplier.pincode}`}
                    </div>
                  )}
